...
class Butterfly(models.Model):
    ...
    butterfly_type_id = models.ForeignKey(ButterflyType, on_delete=models.CASCADE, default=0,
                                          db_column='ButterflyTypeId')
...
class UserButterfly(models.Model):
    ...
    butterfly_id = models.ForeignKey(Butterfly, on_delete=models.CASCADE, default=0, db_column='ButterflyId')

    time_caught = models.DateTimeField(auto_now_add=True, db_column='TimeCaught')

    # Foreign Key, UserInfo:UserId -> UserButterfly:UserId
    user_id = models.ForeignKey(UserInfo, on_delete=models.CASCADE, default=0, db_column='UserId')
